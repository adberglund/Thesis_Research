...
//July 10, 2013
//L1-Approximation LP using the Hanoi WDS, EPANET, and Gurobi Optimizer

//Changing delta, emitterCoeff, iterations and numOfLeaks manipulates the 
//full program
double delta = 2, emitterCoeff = 200;
int numOfLeaks = 2, iterations = 50;
char directoryString[15] = "200-2";
...
int main(int argc, char *argv[]) 
{
	...
	{		
		initializeArrays();
		randomizeLeaks(emitterCoeff, numNodes, 
			numOfLeaks);				
...
{	
	...
	sequentialFile[0] = '\0';
	strcat(sequentialFile, "/home/andrew/Documents/Research/C/L1/LP_Solutions/Solution_");
	for (i = 0; i < numOfLeaks; i++)
	{
...
{	
	...
	//Create summary CSV file for each set of leaks
	sequentialFile[0] = '\0';
	strcat(sequentialFile, "/home/andrew/Documents/Research/C/L1/LP_Solutions/");
